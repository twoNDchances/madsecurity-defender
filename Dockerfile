...
ENV DEFENDER_APP_INFO_ENABLE=true \
    ...
    \
    DEFENDER_SERVER_SECURITY_MANAGER_HOST=192.168.1.14 \
    DEFENDER_SERVER_SECURITY_ENABLE=true \
    DEFENDER_SERVER_SECURITY_USERNAME=admin \
    DEFENDER_SERVER_SECURITY_PASSWORD=12341234 \
    ...
    DEFENDER_SERVER_STORAGE_REDIS_HOST=103.20.97.127 \
    DEFENDER_SERVER_STORAGE_REDIS_PORT=1234 \
    ...
    DEFENDER_PROXY_BACKEND_HOST=103.20.97.127 \
    DEFENDER_PROXY_BACKEND_PORT=8889 \
    ...
    DEFENDER_PROXY_REPORT_API_TOKEN=yNcYAhi048xXdANkp8II6zcTipp5pnUhuFiufjXdYMmag66V \
    DEFENDER_PROXY_REPORT_AUTH_USERNAME=root@madsecurity.2ndproject.site \
    DEFENDER_PROXY_REPORT_AUTH_PASSWORD=root
